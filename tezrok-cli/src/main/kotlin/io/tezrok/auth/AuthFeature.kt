...
internal class AuthFeature : TezrokFeature {
    ...
    private fun addAppProperties(
        ...
        appProps.addNewSettings(
            ...
            "${moduleName}.activation-enabled=\${USER_ACTIVATION:true}",
            "${moduleName}.re-captcha-in-login-enable=\${RECAPTCHA:true}",
            "${moduleName}.re-captcha-in-register-enable=\${RECAPTCHA:true}",
